...
Save loo plots
```{r, eval = F}
ggsave(here("results", "one_smr", "full_models_loo", paste0("ea_cind", Sys.Date(), ".png")), plot = loo.list[[1]] + ggtitle("European ancestry - Cognitive impairment - Leave one out"))
ggsave(here("results", "one_smr", "full_models_loo", paste0("ea_dem", Sys.Date(), ".png")), plot = loo.list[[2]] + ggtitle("European ancestry - Dementia - Leave one out"))
ggsave(here("results", "one_smr", "full_models_loo", paste0("aa_cind", Sys.Date(), ".png")), plot = loo.list[[3]] + ggtitle("African ancestry - Cognitive impairment - Leave one out"))
ggsave(here("results", "one_smr", "full_models_loo", paste0("aa_dem", Sys.Date(), ".png")), plot = loo.list[[4]] + ggtitle("African ancestry - Dementia - Leave one out"))
```
...
# TODO: pull the sensitivity models for ivglm - whole genome PGS, instrument-qualified PGS, and rs1229984
...
```{r}
res.logit <- readRDS(here("results", "conventional_glm", paste0("full_output_table_2023-08-17.rda")))
```
...
## Ancestry covars only
```{r}
ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "pgs.norm", outcome = "AD12.Dementia.outcome", covariates = combined.pgs.covariates)
ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.Dementia.outcome", covariates = ancestry.covars)
ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "pgs.norm", outcome = "AD12.Dementia.outcome", covariates = ancestry.covars)
ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.Dementia.outcome", covariates = ancestry.covars)
```

```{r}
ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "pgs.norm", outcome = "AD12.CIND.outcome", covariates = ancestry.covars)
ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.CIND.outcome", covariates = ancestry.covars)
ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "pgs.norm", outcome = "AD12.CIND.outcome", covariates = ancestry.covars)
ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.CIND.outcome", covariates = ancestry.covars)
```

```{r}
res.binary.ea.pgs <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "pgs.norm", outcome = "AD12.binary", covariates = ancestry.covars)
res.binary.ea.gscan <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.binary", covariates = ancestry.covars)
res.binary.aa.pgs <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "pgs.norm", outcome = "AD12.binary", covariates = ancestry.covars)
res.binary.ea.gscan <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.binary", covariates = ancestry.covars)
```

```{r}
res <- rbind(res.dem.ea, res.dem.aa, res.cind.ea, res.cind.aa)

res.binary <- rbind(res.binary.ea.pgs, res.binary.ea.gscan, res.binary.aa.pgs, res.binary.ea.gscan)
res.binary$outcome <- "binary"
```

```{r}
rbind(res.binary, res.dementia, res.cind)
```
...
forest <- ggplot(data=res,
  ...
  theme_bw() +
  facet_wrap(vars(outcome, model)) +
  theme(text = element_text(size = 18))
forest
```

## Fully adjusted for potential confounders and APOE012 

Dementia in AA models don't converge
```{r}
res.dementia.ea.pgs <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "pgs.norm", outcome = "AD12.Dementia.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.dementia.ea.gscan <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.Dementia.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.dementia.ea.rs1229984 <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "rs1229984", outcome = "AD12.Dementia.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))


res.dementia.aa.pgs <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "pgs.norm", outcome = "AD12.Dementia.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.dementia.aa.gscan <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.Dementia.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.dementia.aa.rs1229984 <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "rs1229984", outcome = "AD12.Dementia.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))


res.dementia <- rbind(res.dementia.ea.pgs, res.dementia.ea.gscan, res.dementia.ea.rs1229984, res.dementia.aa.pgs, res.dementia.aa.gscan, res.dementia.aa.rs1229984)
res.dementia$outcome <- "Dementia"
```

```{r}
res.cind.ea.pgs <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "pgs.norm", outcome = "AD12.CIND.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.cind.ea.gscan <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.CIND.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates)) 
res.cind.ea.rs1229984 <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "rs1229984", outcome = "AD12.CIND.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))

res.cind.aa.pgs <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "pgs.norm", outcome = "AD12.CIND.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.cind.aa.gscan <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.CIND.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.cind.aa.rs1229984 <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "rs1229984", outcome = "AD12.CIND.outcome", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))

res.cind <- rbind(res.cind.ea.pgs, res.cind.ea.gscan, res.cind.ea.rs1229984,  res.cind.aa.pgs, res.cind.aa.gscan, res.cind.aa.rs1229984)
res.cind$outcome <- "CIND"
```

```{r}
res.binary.ea.pgs <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "pgs.norm", outcome = "AD12.binary", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.binary.ea.gscan <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.binary", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.binary.ea.rs1229984 <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "rs1229984", outcome = "AD12.binary", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))

res.binary.aa.pgs <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "pgs.norm", outcome = "AD12.binary", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.binary.aa.gscan <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.binary", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))
res.binary.aa.rs1229984 <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "rs1229984", outcome = "AD12.binary", covariates = c(demographics, "APOE012", additional_covars, combined.pgs.covariates))

res.binary <- rbind(res.binary.ea.pgs, res.binary.ea.gscan, res.binary.ea.rs1229984, res.binary.aa.pgs, res.binary.aa.gscan, res.binary.aa.rs1229984)
res.binary$outcome <- "binary"
```

```{r}
res <- rbind(res.binary, res.dementia, res.cind)
onesmr.individual.variants <- rbind(res.binary, res.dementia, res.cind)
res %>% filter(model == "ts") %>% dplyr::select(variant, outcome, ancestry, estimate, conf.low, conf.high, p.value)
```
...
Dementia in AA models don't converge
```{r}
res.dementia.ea.pgs <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "pgs.norm", outcome = "AD12.Dementia.outcome", covariates = c(precision.covariates, ancestry.covars))
res.dementia.ea.gscan <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.Dementia.outcome", covariates = c(precision.covariates, ancestry.covars))
res.dementia.aa.pgs <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "pgs.norm", outcome = "AD12.Dementia.outcome", covariates = c(precision.covariates, ancestry.covars))
res.dementia.aa.gscan <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.Dementia.outcome", covariates = c(precision.covariates, ancestry.covars))

res.dementia <- rbind(res.dementia.ea.pgs, res.dementia.ea.gscan, res.dementia.aa.pgs, res.dementia.aa.gscan)
res.dementia$outcome <- "Dementia"
```

```{r}
res.cind.ea.pgs <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "pgs.norm", outcome = "AD12.CIND.outcome", covariates = c(precision.covariates, ancestry.covars))
res.cind.ea.gscan <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.CIND.outcome", covariates = c(precision.covariates, ancestry.covars))
res.cind.aa.pgs <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "pgs.norm", outcome = "AD12.CIND.outcome", covariates = c(precision.covariates, ancestry.covars))
res.cind.aa.gscan <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.CIND.outcome", covariates = c(precision.covariates, ancestry.covars))

res.cind <- rbind(res.cind.ea.pgs, res.cind.ea.gscan, res.cind.aa.pgs, res.cind.aa.gscan)
res.cind$outcome <- "CIND"
```

```{r}
res.binary.ea.pgs <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "pgs.norm", outcome = "AD12.binary", covariates = c(precision.covariates, ancestry.covars))
res.binary.ea.gscan <- ivglm_model_exp_num(data = dat.ea, exposure = "log2drinkpweek", ancestry = "ea", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.binary", covariates = c(precision.covariates, ancestry.covars))
res.binary.aa.pgs <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "pgs.norm", outcome = "AD12.binary", covariates = c(precision.covariates, ancestry.covars))
res.binary.aa.gscan <- ivglm_model_exp_num(data = dat.aa, exposure = "log2drinkpweek", ancestry = "aa", variant = "PGS4_DPW_GSCAN19", outcome = "AD12.binary", covariates = c(precision.covariates, ancestry.covars))

res.binary <- rbind(res.binary.ea.pgs, res.binary.ea.gscan, res.binary.aa.pgs, res.binary.aa.gscan)
res.binary$outcome <- "binary"
```
