...
Phenotype variation explained (PVE) is a substitute for R^2 in summary GWAS data (h^2, heritability). Calculate F statistic from that, total F-stat based on mzfu's code. Should the F statistic be calculated in the context of the entire GWAS or in just the high SNPs? Or just the SNPs that will be in the model?
