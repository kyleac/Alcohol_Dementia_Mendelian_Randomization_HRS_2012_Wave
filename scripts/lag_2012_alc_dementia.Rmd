...
Save a copy for export/use.
```{r}
#saveRDS(dat, here("data", paste0(Sys.Date(), "_kac_democogwide_alc_dem_formatted.rda")))
```
...
TODO: consider filter out prevalent cases with prior to 60 onset
```{r}
