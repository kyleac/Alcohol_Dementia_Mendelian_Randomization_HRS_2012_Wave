...
## Inclusion/exclusion comparison - all 2012 participants current drinkers with confirmed ancestry
### European ancestry
Get a dataset with dummy selection variable
```{r}
included.ea <-
...
#inex.table.merged %>% as_flex_table %>% save_as_docx(path = here("results", "analytic", paste0(Sys.Date(), "_inclusion_exclusion_comparison_by_race_current_drinkers.docx")))
```
...
## Explore PGS performance among drinkers and non-drinkers
